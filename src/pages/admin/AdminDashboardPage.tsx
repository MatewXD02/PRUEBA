...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="rounded-lg border border-primary/30 bg-card/95 px-3 py-2 shadow-xl backdrop-blur-sm sm:px-4 sm:py-3">
        <p className="mb-1.5 text-xs font-medium text-primary sm:mb-2 sm:text-sm">{label}</p>
    ...
    <div className="max-w-full space-y-4 overflow-x-hidden bg-background p-4 md:space-y-6 md:p-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground md:text-base">Centro de control de EthosHub</p>
        </div>
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:gap-3">
          ...
          <div className="flex flex-1 items-center justify-center rounded-lg border border-primary/30 bg-card p-1 sm:flex-none">
      ...
      <div className="grid w-full grid-cols-1 gap-3 sm:grid-cols-2 md:gap-4 lg:grid-cols-4">
        {kpiStats.map((stat, index) => (
          ...
          >
            <div className="group relative overflow-hidden rounded-xl border border-primary/20 bg-card p-4 transition-all hover:border-primary/40 md:p-6">
              {/* Lilac glow effect */}
              ...
              <div className="relative flex items-start justify-between">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-purple-600 shadow-lg shadow-primary/25 md:h-12 md:w-12">
                  <stat.icon className="h-5 w-5 text-primary-foreground md:h-6 md:w-6" />
                </div>
                <Badge
                  variant="secondary"
                  className={cn(
              ...
              <div className="relative mt-3 md:mt-4">
                <p className="font-sans text-2xl font-bold text-foreground md:text-3xl">{stat.value}</p>
      ...
      <div className="grid w-full grid-cols-1 gap-4 md:gap-6 lg:grid-cols-3">
        ...
        >
          <div className="rounded-xl border border-primary/20 bg-card p-4 md:p-6">
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between md:mb-6">
              <div>
                <h2 className="font-sans text-base font-semibold text-foreground md:text-lg">Crecimiento de Usuarios</h2>
                <p className="text-xs text-muted-foreground md:text-sm">Ultimos {selectedRange} dias</p>
              </div>
              <div className="flex items-center gap-3 text-xs sm:gap-4 sm:text-sm">
                <div className="flex items-center gap-2">
                  <div className="h-2.5 w-2.5 rounded-full bg-primary shadow-sm shadow-primary/50 sm:h-3 sm:w-3" />
        ...
        >
          <div className="h-full rounded-xl border border-primary/20 bg-card p-4 md:p-6">
            <div className="mb-4">
              <h2 className="font-sans text-base font-semibold text-foreground md:text-lg">Distribucion por Rol</h2>
              <p className="text-xs text-muted-foreground md:text-sm">core_types.rol_ethoshub</p>
            </div>
      ...
      <div className="grid w-full grid-cols-1 gap-4 md:gap-6 lg:grid-cols-2">
        ...
        >
          <div className="rounded-xl border border-primary/20 bg-card p-4 md:p-6">
            <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between md:mb-6">
              <div>
                <h2 className="font-sans text-base font-semibold text-foreground md:text-lg">Top 5 Skills</h2>
                <p className="text-xs text-muted-foreground md:text-sm">Habilidades mas agregadas en la plataforma</p>
              </div>
              <Badge variant="secondary" className="w-fit border-0 bg-primary/15 text-primary">
            ...
            <div className="mt-3 flex flex-wrap gap-1.5 md:mt-4 md:gap-2">
              {topSkills.map((skill) => (
                <div 
                  key={skill.name}
                  className="flex items-center gap-1 rounded-full border border-primary/20 bg-primary/10 px-2 py-0.5 text-[10px] sm:gap-1.5 sm:px-2.5 sm:py-1 sm:text-xs"
                >
          ...
          <div className="rounded-xl border border-primary/20 bg-card p-4 md:p-6">
            <div className="mb-4 flex items-center justify-between">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary/20 to-purple-500/20 sm:h-10 sm:w-10">
                  <Terminal className="h-4 w-4 text-primary sm:h-5 sm:w-5" />
                </div>
                <div>
                  <h2 className="font-sans text-base font-semibold text-foreground md:text-lg">System Logs</h2>
                  <p className="text-[10px] text-muted-foreground sm:text-xs">admin.system_logs</p>
                </div>
              </div>
              <div className="flex items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 sm:gap-2 sm:px-3 sm:py-1">
                <span className="relative flex h-2 w-2">
                  <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-emerald-400 opacity-75" />
                  <span className="relative inline-flex h-2 w-2 rounded-full bg-emerald-500" />
                </span>
                <span className="text-[10px] font-medium text-emerald-400 sm:text-xs">LIVE</span>
              </div>
            </div>
            <div 
              ref={logContainerRef}
              className="h-56 overflow-y-auto rounded-lg border border-primary/10 bg-background p-3 font-mono text-[10px] scrollbar-hide sm:h-72 sm:p-4 sm:text-xs"
      ...
      >
        <div className="rounded-xl border border-primary/20 bg-card p-4 md:p-6">
          <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between md:mb-6">
            <div>
              <h2 className="font-sans text-base font-semibold text-foreground md:text-lg">Estado del Sistema</h2>
              <p className="text-xs text-muted-foreground md:text-sm">Monitoreo en tiempo real</p>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
            {[
              ...
              <motion.div
                ...
                className="group relative flex flex-col items-center gap-2 overflow-hidden rounded-xl border border-primary/20 bg-background p-3 transition-all hover:border-primary/40 sm:gap-3 sm:p-5"
              >
                {/* Animated background pulse */}
                <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-transparent opacity-0 transition-opacity group-hover:opacity-100" />
                
                <div className="relative">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-primary/20 to-purple-500/20 transition-all group-hover:from-primary/30 group-hover:to-purple-500/30 sm:h-14 sm:w-14">
                    <service.icon className="h-5 w-5 text-primary sm:h-7 sm:w-7" />
                  </div>
                  {/* Status indicator */}
                ...
                <div className="relative text-center">
                  <p className="font-sans text-xs font-medium text-foreground sm:text-sm">{service.name}</p>
